...
if (isset($_POST["edit"])) {
    ...
    if (!$error) {
        if ($_FILES["picture"]["error"] != 4) {
            ...
            $sqlUpdate = "UPDATE `user` SET `first_name`='$first_name',`last_name`='$last_name',`dob`='$dob',`phone_number`='$phone_number',`address`='$address',`picture`='$picture' WHERE user_id = $session";
        } else {
            $sqlUpdate = "UPDATE `user` SET `first_name`='$first_name',`last_name`='$last_name',`dob`='$dob',`phone_number`='$phone_number',`address`='$address' WHERE user_id = $session";
        }
